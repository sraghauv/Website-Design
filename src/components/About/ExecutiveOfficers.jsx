...
const ExecutiveOfficers = () => {
  return (
    <div>
      ...
      <ContactCard name="Taima Crean" title="President" img="src/components/About/OfficerImages/Taima_Crean.jpg" styleClass="pfp-circle" linkedin="https://www.linkedin.com/in/taima00">
      ...
      <ContactCard name="Holland Ernst" title="Captain" img="src/components/About/OfficerImages/Holland_Ernst.jpg" styleClass="pfp-circle" linkedin="https://www.linkedin.com/in/holland-ernst">
