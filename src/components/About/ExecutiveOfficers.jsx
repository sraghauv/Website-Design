...
const ExecutiveOfficers = () => {
  return (
    <div>
      ...
      <ContactCard name="Taima Crean" title="President" img="src/components/About/OfficerImages/Taima_Crean.jpg" styleClass="pfp taima" linkedin="https://www.linkedin.com/in/taima00">
      ...
      <ContactCard name="Holland Ernst" title="Captain" img="src/components/About/OfficerImages/holland1.jpg" styleClass="pfp holland" linkedin="https://www.linkedin.com/in/holland-ernst">
