...
const LeadershipTeam = () => {
  return (
    <div className="content">
      ...
      {/* Left Side */}
      <div className="half">
        <ContactCard name="Julian Weaver" title="R&D Lead" img="src/components/About/OfficerImages/julian-weaver.jpeg" styleClass="pfp-circle" linkedin="https://www.linkedin.com/in/julian-weaver">
        ...
        <ContactCard name="Tony Chae" title="VP of Outreach" img="src/components/About/OfficerImages/tony_chae.jpg" styleClass="pfp-circle" linkedin="https://www.linkedin.com/in/tony-chae-3bb600249">
        ...
        <ContactCard name="Debarghya" title="VP of Finance" img="src/components/About/OfficerImages/Chaki.jpg" styleClass="pfp-circle" linkedin="https://www.linkedin.com/in/dchaki">
      ...
      {/* Right Side */}
      <div className="half">
        <ContactCard name="Alan Fletcher" title="Hardware Lead" img="src/components/About/OfficerImages/Alan_Fletcher.jpg" styleClass="pfp-circle" linkedin="https://www.linkedin.com/in/alan-fletcher01">
        ...
        <ContactCard name="Nathan Feldt" title="Software Lead" img="src/components/About/OfficerImages/Nathan_Feldt.jpg" styleClass="pfp-circle" linkedin="https://www.linkedin.com/in/nathan-feldt-1b6573229">
        ...
        <ContactCard name="Jay Damodaran" title="VP of Membership" img="src/components/About/OfficerImages/Jay.png" styleClass="pfp-circle" linkedin="https://www.linkedin.com/in/jaydamobme">
        ...
        <ContactCard name="Vivek Beeram" title="Machine Learning Specialist" img="src/components/About/OfficerImages/Vivek_Beeram.jpg" styleClass="pfp-circle" linkedin="https://www.linkedin.com/in/vivek-beeram-370852212">
